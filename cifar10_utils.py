...
# read_data_sets = get_cifar10()
# train_dataset = read_data_sets['train']
# print(train_dataset)
...
# # Reshape the sample tensor from (C, H, W) to (H, W, C)
# sample = sample.transpose((1, 2, 0))
# # Denormalize the sample (undo the normalization applied during data loading)
# mean = (0.491, 0.482, 0.447)
# std = (0.247, 0.243, 0.262)
